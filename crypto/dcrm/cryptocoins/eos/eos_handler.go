...
*/
	...
	log.Debug("===============EOSHandler.GetTransactionInfo===============","req url",req,"txhash",txhash)
	resp, err1 := http.Get(req)
	if err1 != nil {
		err = err1
		return
	}
	log.Debug("===============EOSHandler.GetTransactionInfo===============","get response from url req",resp,"txhash",txhash)
	...
	log.Debug("===============EOSHandler.GetTransactionInfo===============","get body from response",string(body),"txhash",txhash)
	var b interface{}
	...
	log.Debug("===============EOSHandler.GetTransactionInfo===============","get tx str from body",string(txstr),"txhash",txhash)
	var eostx EOSTx
	...
	log.Debug("===============EOSHandler.GetTransactionInfo===============","get from addr from txstr",string(fromAddress),"txhash",txhash)
...
func CreateNewAccount(creatorName, creatorActivePrivKey, accountName, ownerkey, activekey string, buyram uint32) (bool, error) {
	defer func () {
		if r := recover(); r != nil {
			log.Debug("create new account","error",r)
		}
	}()
