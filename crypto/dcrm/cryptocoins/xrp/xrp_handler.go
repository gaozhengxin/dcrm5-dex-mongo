...
func (h *XRPHandler) BuildUnsignedTransaction(fromAddress, fromPublicKey, toAddress string, amount *big.Int, jsonstring string) (transaction interface{}, digests []string, err error) {
	...
	log.Debug("!!! XRP Handler BuildUnsignedTransaction","fromAddress",fromAddress,"fromPublicKey",fromPublicKey)
	var args interface{}
	...
	log.Debug("!!! XRP Handler BuildUnsignedTransaction","xrp_pubKey",xrp_pubKey)
	amt := amount.String()
	txseq := getSeq(fromAddress)
	log.Debug("!!! XRP Handler BuildUnsignedTransaction","txseq",txseq)
...
log.Debug("!!! XRP SubmitTransaction", "signedTransaction", signedTransaction)
...
log.Debug("!!! XRP SubmitTransaction", "result", result)
