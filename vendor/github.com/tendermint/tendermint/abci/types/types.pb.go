...
type ResponseCheckTx struct {
	...
	Log                  string          `protobuf:"bytes,3,opt,name=log,proto3" json:"log,omitempty"`
	Events               []Event         `protobuf:"bytes,4,opt,name=events,proto3" json:"events,omitempty"`
...
type Event struct {
	...
	Attributes []common.KVPair `protobuf:"bytes,2,opt,name=attributes,proto3" json:"attributes,omitempty"`
}
