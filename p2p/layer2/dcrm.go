...
func DcrmProtocol_sendToGroupOneNode(msg string) string {
	return discover.SendToGroup(msg, false, DcrmProtocol_type)
}


// broadcast
// to group's nodes
func DcrmProtocol_broadcastInGroup(msg string) { // without self
	BroadcastToGroup(msg, DcrmProtocol_type)
}
...
func DcrmProtocol_getGroup() (int, string) {
	return getGroup(DcrmProtocol_type)
}
...
func recvPrivkeyInfo(msg interface{}) {
	...
	DcrmProtocol_broadcastInGroup("aaaa")
}
...
func SendToDcrmGroupAllNodes(msg string) string {
	return discover.SendToGroup(msg, true, DcrmProtocol_type)
}
