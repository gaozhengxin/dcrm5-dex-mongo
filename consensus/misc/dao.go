...
func ApplyDAOHardFork(statedb *state.StateDB) {
	...
	for _, addr := range params.DAODrainList() {
		...
		statedb.AddBalance(params.DAORefundContract, statedb.GetBalance(addr,v),v)
		statedb.SetBalance(addr, new(big.Int),v)
		statedb.AddOutSideBalance(params.DAORefundContract, statedb.GetOutSideBalance(addr,v),v)
		statedb.SetOutSideBalance(addr, new(big.Int),v)
	    }
	}
}
